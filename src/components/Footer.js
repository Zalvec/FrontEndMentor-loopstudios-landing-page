    ...
    return (
        <section className="footer">
          <div className="container">
            <article className="footer_box">
              ...
              <section className="right_footer">
                <article className="icons">
                  <a href="/">
                    <FontAwesomeIcon icon={["fab", "facebook-square"]} size="2x" className="fontAwesome_icon"/>
                  </a>
                  <a href="/">
                    <FontAwesomeIcon icon={["fab", "twitter"]} size="2x" className="fontAwesome_icon"/>
                  </a>
                  <a href="/">
                    <FontAwesomeIcon icon={["fab", "pinterest"]} size="2x" className="fontAwesome_icon"/>
                  </a>
                  <a href="/">
                    <FontAwesomeIcon icon={["fab", "instagram"]} size="2x" className="fontAwesome_icon"/>
                  </a>
                </article>
            ...
            Challenge by <a href="https://www.frontendmentor.io?ref=challenge" target="_blank" rel="noreferrer" className="no-hover">Frontend Mentor</a>. 
            Coded by <a href="https://roelvanbilzen.be" className="no-hover">Roel Van Bilzen</a>.
          </article>
          </div>
